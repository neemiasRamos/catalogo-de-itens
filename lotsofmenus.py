...
User1 = User(name="Pedro Lyra", email="pepelyra@gmail.com",
             picture='''http://www.firstcoastyo.com/wp-content/uploads
             /2017/07/blank-avatar-220x220-400x400.png''')
session.add(User1)
session.commit()
...
menuItem7 = MenuItem(
    user_id=1, name="Grilled Cheese Sandwich",
...
menuItem2 = MenuItem(
    ...
    description=''' A famous duck dish from Beijing[1]
        ...
        The meat is prized for its thin, crisp skin, with authentic versions of
        the dish serving mostly the skin and little meat, sliced in front
...
menuItem3 = MenuItem(
    user_id=1, name="Spicy Tuna Roll",
...
menuItem5 = MenuItem(
    user_id=1, name="Beef Noodle Soup",
    description='''A Chinese noodle soup made of stewed or
        red braised beef, beef broth, vegetables and Chinese noodles.''',
...
menuItem2 = MenuItem(
    user_id=1, name="Chinese Dumplings",
    description='''a common Chinese dumpling which generally
        consists of minced meat and finely
...
menuItem1 = MenuItem(
    ...
    description='''Rich, luscious sponge
        cake soaked in sweet milk and topped with
        vanilla bean whipped cream and strawberries.''',
...
menuItem2 = MenuItem(
    user_id=1, name="Mushroom risotto",
...
menuItem3 = MenuItem(
    user_id=1, name="Honey Boba Shaved Snow",
    description='''Milk snow layered with honey boba, jasmine tea jelly,
        grass jelly, caramel, cream, and freshly made mochi''',
...
menuItem4 = MenuItem(
    user_id=1, name="Cauliflower Manchurian",
    description='''Golden fried cauliflower florets
        in a midly spiced soya,garlic sauce cooked with fresh cilantro,
...
menuItem5 = MenuItem(
    user_id=1, name="Aloo Gobi Burrito",
...
menuItem5 = MenuItem(
    ...
    description='''Noodles in a delicious
...
menuItem2 = MenuItem(
    user_id=1, name="Chicken Marsala",
...
menuItem9 = MenuItem(
    ...
    description='''Fresh battered sirloin
        steak fried and smothered with cream gravy''', price="$8.99",
    course="Entree", restaurant=restaurant1)
...
menuItem1 = MenuItem(
    user_id=1, name="Boysenberry Sorbet",
    description='''An unsettlingly huge amount
        of ripe berries turned into frozen (and seedless) awesomeness''',
    price="$2.99", course="Dessert", restaurant=restaurant1)
...
menuItem3 = MenuItem(
    user_id=1, name="Morels on toast (seasonal)",
...
menuItem4 = MenuItem(
    user_id=1, name="Tandoori Chicken",
    description='''Chicken marinated in yoghurt
        and seasoned with a spicy mix(chilli, tamarind among others)
        and slow cooked in a cylindrical clay or metal oven which gets its
        heat from burning charcoal.''',
...
menuItem10 = MenuItem(
    user_id=1, name="Spinach Ice Cream",
...
menuItem1 = MenuItem(
    user_id=1, name="Super Burrito Al Pastor",
...
menuItem1 = MenuItem(
    user_id=1, name="Chantrelle Toast",
...
menuItem1 = MenuItem(
    user_id=1, name="Guanciale Chawanmushi",
    description='''Japanese egg custard served
        hot with spicey Italian Pork Jowl (guanciale)''',
...
menuItem1 = MenuItem(
    ...
    description='''Lemon Curd Ice Cream Sandwich
        on a chocolate macaron with cardamom meringue and cashews''',
